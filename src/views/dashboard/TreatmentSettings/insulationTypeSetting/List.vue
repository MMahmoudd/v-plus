    ...
    <v-card>
      <v-card-title>
        ...
        <router-link
          ...
          :to="{ path: '/treatment-settings/insulationTypeSettingForm/'}"
          color="blue"
        >
          <v-btn
            class="mx-2"
        ...
        >
          ...
          >
            <template v-slot:activator="{ on, attrs }">
              <router-link
                :to="'/treatment-settings/insulationTypeSettingForm/' + item.id"
              >
                <v-btn
                  small
                  fab
...
<script>
  ...
  const SettingService = ServiceFactory.get('insulationTypeSetting')
