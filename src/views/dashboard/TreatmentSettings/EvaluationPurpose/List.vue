    ...
    <v-card>
      <v-card-title>
        ...
        <router-link
          ...
          :to="{ path: '/treatment-settings/EvaluationPurposeForm/'}"
          color="blue"
        >
          <v-btn
            class="mx-2"
        ...
        >
          ...
          >
            <template v-slot:activator="{ on, attrs }">
              <router-link
                :to="'/treatment-settings/EvaluationPurposeForm/' + item.id"
              >
                <v-btn
                  small
                  fab
  ...
  export default {
    ...
    methods: {
      ...
      async fetchAllItems () {
        ...
        const { data } = await SettingService.getAllItems(itemsPerPage, page, pageNumber)
