    ...
    <v-card>
      <v-card-title>
        ...
        <router-link
          ...
          :to="{ path: '/treatment-settings/structureConstructionSettingForm/'}"
          color="blue"
        >
          <v-btn
            class="mx-2"
        ...
        >
          ...
          >
            <template v-slot:activator="{ on, attrs }">
              <router-link
                :to="'/treatment-settings/structureConstructionSettingForm/' + item.id"
              >
                <v-btn
                  small
                  fab
...
<script>
  ...
  const SettingService = ServiceFactory.get('structureConstructionSetting')
