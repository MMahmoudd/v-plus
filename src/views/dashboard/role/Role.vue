  ...
  export default {
    ...
    data: (vm) => ({
      ...
      headers: [
        ...
        { text: vm.$t('role.roleName'), sortable: false, value: 'roleName' },
        { text: vm.$t('role.roleGroup'), sortable: false, value: 'roleGroup' },
    ...
    methods: {
      async fetchAllItems () {
        ...
        const Roles = await RoleService.getAllItems(itemsPerPage, page, pageNumber)
